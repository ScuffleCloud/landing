        ...
        <Flex direction="column" gap={15}>
            <Flex gap={4} direction="column">
                ...
                <p>
                    ...
                    Our initial focus is on delivering high-quality video streaming solutions for both static and real-time video content.
                </p>
            </Flex>
            <Flex gap={4} direction="column">
                <h3>Open Source - Community driven vision</h3>
                <p>
                    Scuffle aims to be a community-driven platform, built from the ground up with transparency and openness in mind. Licensed under AGPL3, Apache 2.0, and MIT*.
                </p>
            </Flex>
        </Flex>
    </Flex>
    ...
    <div class="features-container">
        <section class="features-main">
            ...
            <p class="feature-description">
                ...
                cutting-edge tools and libraries.<br><br>
                Explore our comprehensive suite of features and discover how we 
                can help you elevate your digital presence and achieve your 
                business goals.<br>
        ...
        <section class="features-performance">
            ...
            <div class="grid">
                ...
                <div class="card">
                    ...
                    <h3>AV1 Encoding</h3>
                    <p>Utilize AV1 next generation video encoding for efficient and high-quality video compression.</p>
                </div>
                ...
                <div class="card">
                    ...
                    <p>Your security is our priority, we implement robust encryption methods that protect your video content from unauthorized access.</p>
                </div>

                <div class="card">
                    <div class="features-pill filled">HOSTING</div>
                    <h3>Encrypted Broadcasts</h3>
                    <p>Host the video stack on your own infrastructure, giving you the full control over your data and resources.</p>
                </div>
            </div>
        </section>
            ...
            <div class="grid">
                <div class="card">
                    ...
                    <div class="content-wrapper">
                        ...
                        <p>Support for multiple audio and video tracks, enabling flexible streaming options.</p>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="content-wrapper">
                        ...
                        <p>Record and playback live streams, providing a convenient way to catch up on missed content.</p>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="content-wrapper">
                        ...
                        <p>Easily create and share live stream highlights to engage and grow your audience.</p>
                    </div>
                </div>
            </div>
        </section>
